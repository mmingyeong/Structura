...
def main():
    ...
    # ------------------------------------------------------------------
    x_min = 100  # cMpc/h
    x_max = 120  # cMpc/h (10 cMpc/h thickness)
    ...
    # Here, we use 60 workers (e.g., fixed worker count) for optimal performance.
    ...
    # ------------------------------------------------------------------
    # Visualization block is currently disabled.
    # If visualization is needed, uncomment the following block.
    # ------------------------------------------------------------------
    """
    ...
    logger.info("Plot generation (if enabled) completed successfully.")
...
if __name__ == '__main__':
    ...
    # Sort profiling results by cumulative time and save to profile_results.txt
    s = io.StringIO()
